...
- API Gateway HTTP API exposing the Lambda, including pairing, usage summary, enrollment, heartbeat, usage event ingestion, command polling, and policy fetch routes.
